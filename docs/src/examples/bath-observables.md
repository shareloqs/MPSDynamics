...
$$
    \langle \hat b_k^\dagger \hat b_k \rangle = \cosh{\theta_k}\sinh{\theta_k} \Big(\langle\hat a_{2k}\hat a_{1k}\rangle + \langle \hat a_{1k}^\dagger\hat a_{2k}^\dagger\rangle \Big) + \sinh^2{\theta_k} \Big(1+ \langle \hat a_{2k}^\dagger \hat a_{2k} \rangle \Big) + \\ 
