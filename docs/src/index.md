...
```@contents
Pages = ["index.md", "user-guide.md", "Examples" => ["examples/sbm.md", "examples/puredephasing.md", "examples/timedep.md", "examples/anderson-model.md", "examples/bath-observables.md"], "theory.md", "methods.md", "dev.md"]
Depth = 3
```
